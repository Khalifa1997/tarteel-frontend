...
const EN: Shape = {
  messages: {
    ...
    // PARTNERS PAGE
    [KEYS.PARTNERS_PARAGRAPH]: "We have proudly partnered with these orgs to further mission of Tarteel. If you're interested in partenering with us, <a href='/contact'>get in touch</a>!",
